...
var timeTrackerApp = angular.module('timeTrackerApp', ['ui.bootstrap']);

timeTrackerApp.config(function($routeProvider, $locationProvider, $httpProvider, $compileProvider) {
    $routeProvider
        .when('/',
            {
                controller: 'GridController',
                templateUrl: '/partials/timeEntryView.html'
            })
        .when('/reports',
            {
                //controller: 'GridController',
...
.run(function ($rootScope, $location, $window, $templateCache, AuthenticationService) {
